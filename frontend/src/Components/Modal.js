...
class Modal extends Component{
    ...
    renderForm = ()=>{
        ...
        if(typeModal === 'edit'){
            ...
            return (
                <div className="Add-Post Post-Edit">
                    <h2 className="heading-2">Edit {author} Comment {error === 'Success' && 'Success'}</h2>
                    {error !== 'Success' && 
            ...
            return (
                <div className="Add-Post Post-Edit">
                    <h2 className="heading-2">Delete Comment {error === 'Success' && 'Success'}</h2>
                    {error !== 'Success' && <p>Are you sure !!!</p>}
            ...
            return (
                <div className="Add-Post Post-Edit">
                    <h2 className="heading-2">Delete Post {error === 'Success' && 'Success'}</h2>
                    {error !== 'Success' && <p>Are you sure !!!</p>}
